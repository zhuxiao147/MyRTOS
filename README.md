...
EZRTOS is a lightweight real-time operating system (RTOS) designed for embedded systems, focusing on clarity, modularity, and ease of use. This project is suitable for learning, research, and small embedded applications.
